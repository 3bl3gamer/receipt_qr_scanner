...
func TestParseReceiptRef(t *testing.T) {
	tests := []struct {
		...
		{
			// https://ofd.beeline.kz/t/?i=123456789012&f=012345678901&s=12345.0&t=20241108T123456
			qrText:        "https://ofd.beeline.kz/t/?i=123456789012&f=012345678901&s=12345.0&t=20241108T123456",
			wantFiscalID:  "123456789012",
			wantKkmFnsId:  "012345678901",
			wantSum:       12345.0,
			wantDate:      "2024-11-08 12:34:56",
			wantUniqKey:   "kz-bee:f=012345678901&i=123456789012&s=12345.0&t=20241108T123456",
			wantSearchKey: "_created_at:2024-11-08 12:34   _fiscal_id:123456789012   _kkm_fns_id:012345678901   _sum:12345.00",
		},
	}
	...
	for _, tt := range tests {
		t.Run(tt.qrText, func(t *testing.T) {
			...
			if ref.Domain().Code != "kz-bee" {
				t.Errorf("Domain().Code = %v, want kz-bee", ref.Domain().Code)
			}
...
func TestUniqueKeyConsistency(t *testing.T) {
	...
	qr1 := "https://ofd.beeline.kz/t/?i=123456789012&f=012345678901&s=12345.0&t=20241108T123456"
	qr2 := "https://ofd.beeline.kz/t/?f=012345678901&s=12345.0&i=123456789012&t=20241108T123456"
